...
const { requireApprovedRecruiter } = require("../middlewares/recruiterValidation.middleware")
const upload = require("../middlewares/upload.middleware");

router.post("/", auth, requireApprovedRecruiter, createOffer)
...
router.get("/my-offers", auth, requireApprovedRecruiter, getMyOffers)
router.put("/application/:candidatureId", auth, requireApprovedRecruiter, updateApplicationStatus)
